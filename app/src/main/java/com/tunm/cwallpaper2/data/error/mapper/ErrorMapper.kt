...
import com.tunm.cwallpaper2.data.error.*
...
class ErrorMapper @Inject constructor(@ApplicationContext val context: Context) :
    ...
    override val errorsMap: Map<Int, String>
        get() = mapOf(
            ...
            Pair(EMAIL_ERROR, getErrorString(R.string.invalid_email)),
            ...
            Pair(CREATE_FB_AUTH_ERROR, getErrorString(R.string.search_error))
